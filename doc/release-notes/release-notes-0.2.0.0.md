TrollCoin version 0.2.0.0 is now available from:
...
TrollCoin data directory (listed below) and delete everything except the
wallet.dat and TrollCoin.conf

Linux : ~/.TrollCoin/

Windows : %appdata%\Roaming\TrollCoin
...
- `62a3da1` Update GitHub URLs to point to TrollCoinFoundation/TrollCoin
...
- `19ca0ef` Point GitHub URL to TrollCoinFoundation
