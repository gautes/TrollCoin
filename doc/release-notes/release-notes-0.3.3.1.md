TrollCoin version 0.3.3.1 is now available from:
...
Added support for TrollCoin URIs in QT wallet.
...
- `722c5dc` Change strings to TrollCoin (uppercase) and other miscellaneous fixes
- `18993f7` Correct translatable string from Bitcoin to TrollCoin
- `a0cb315` Remove duplicate spaces from a string
- `648fc59` Add an option to open the TrollCoin.conf in the default editor
- `80dbe2e` Add a notice when selecting edit config in QT
- `02d42ae` Fix Opening on OSX
- `4898c94` TrollCoin-Qt (Windows only): extend Resource File
...
- `0142107` Change Window title to "TrollCoin - Wallet" / misc related renames
...
- `f687b68` Add support for opening TrollCoin: URIs directly.
...
- `c5c281a` Rename project to TrollCoin-qt
...
- `ca2ae7a` Rename rpcuser from bitcoinrpc --> TrollCoinrpc in message dialog
