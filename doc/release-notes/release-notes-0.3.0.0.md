TrollCoin version 0.3.0.0 is now available from:
...
- `bfe7f71` use TrollCoin keys for tests
- `971cc03` use TrollCoin transaction for tests
- `fb9f6ab` use new version for tests
- `e805876` Remove checknbits test
- `3eb37a5` remove loop define
- `c10e31d` Rename test_bitcoin.cpp to test_TrollCoin.cpp
