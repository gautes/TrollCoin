...
// testnet dns seed begins with 't', all else are TrollCoin dns seeds.
static const char *strDNSSeed[][2] = {
    {"dnsseed.TrollCoin.com", "dnsseed.TrollCoin.com"},
    {"dnsseed.TrollCoinfoundation.org", "dnsseed.TrollCoinfoundation.org"},
    {"dnsseed.xpydev.org", "dnsseed.xpydev.org"},
    {"tseed.TrollCoin.com", "tseed.TrollCoin.com"},
    {"testnet-seed.TrollCoin.mitchellcash.com", "testnet-seed.TrollCoin.mitchellcash.com"} // Mitchell Cash
};
...
unsigned int pnSeed[] =
{
    // Hard Code DNS Seed IPS for TrollCoin, TrollCoinfoundation, xpydev
...
void StartNode(void* parg)
{
    ...
    // TrollCoin: mint proof-of-stake blocks in the background
