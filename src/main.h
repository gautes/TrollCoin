...
static const int64 MIN_TX_FEE = 0.0;
static const int64 MIN_RELAY_TX_FEE = 0.0;
...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // TrollCoin: get transaction coin age
...
public:
    ...
    // TrollCoin: block signature - signed by coin base txout[0]'s owner
    ...
    // TrollCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // TrollCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // TrollCoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // TrollCoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // TrollCoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // TrollCoin: block index flags
    enum
    {
