       ...
       OptionsPage(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start TrollCoin on system login"));
    bitcoin_at_startup->setToolTip(tr("Automatically start TrollCoin after logging in to the system"));
    ...
    OptionsPage(parent), restart_warning_displayed(false)
{
    ...
    lang->setToolTip(tr("The user interface language can be set here. This setting will only take effect after restarting TrollCoin."));
    ...
    display_addresses->setToolTip(tr("Whether to show TrollCoin addresses in the transaction list"));
       ...
       OptionsPage(parent)
{
    ...
    map_port_upnp->setToolTip(tr("Automatically open the TrollCoin client port on the router. This only works when your router supports UPnP and it is enabled."));
    layout->addWidget(map_port_upnp);

    connect_socks4 = new QCheckBox(tr("&Connect through SOCKS4 proxy:"));
    connect_socks4->setToolTip(tr("Connect to the TrollCoin network through a SOCKS4 proxy (e.g. when connecting through Tor)"));
