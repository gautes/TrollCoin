...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "TrollCoind createmultisig 2 \"[\\\"PCHAhUGKiFKDHKW8Pgw3qrp2vMfhwWjuCo\\\",\\\"PJrhyo8CUvFZQT8j67Expre2PYLhavnHXb\\\"]\""
            "\nAs a json rpc call\n"
...
Value walletpassphrase(const Array& params, bool fHelp)
{
    ...
    // TrollCoin: if user OS account compromised prevent trivial sendmoney commands
    if (params.size() > 2)
...
// TrollCoin: reserve balance from being staked for network protection
...
// TrollCoin: check wallet integrity
...
// TrollCoin: make a public-private key pair
